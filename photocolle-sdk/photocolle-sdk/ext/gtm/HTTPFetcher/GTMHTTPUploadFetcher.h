...
//
// This subclass of DCGTMHTTPFetcher simulates the series of fetches
...
@interface DCGTMHTTPUploadFetcher : DCGTMHTTPFetcher {
  DCGTMHTTPFetcher *chunkFetcher_;
...
+ (DCGTMHTTPUploadFetcher *)uploadFetcherWithRequest:(NSURLRequest *)request
                                    ...
                                    fetcherService:(DCGTMHTTPFetcherService *)fetcherServiceOrNil;
