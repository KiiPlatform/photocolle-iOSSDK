...
// generated by a common DCGTMHTTPFetcherService instance, like
//
//   DCGTMHTTPFetcherService *myFetcherService = [[DCGTMHTTPFetcherService alloc] init];
//   DCGTMHTTPFetcher* myFirstFetcher = [myFetcherService fetcherWithRequest:request1];
//   DCGTMHTTPFetcher* mySecondFetcher = [myFetcherService fetcherWithRequest:request2];

#import "GTMHTTPFetcher.h"
#import "GTMHTTPFetchHistory.h"

@interface DCGTMHTTPFetcherService : NSObject<DCGTMHTTPFetcherServiceProtocol> {
 @private
  NSMutableDictionary *delayedHosts_;
  NSMutableDictionary *runningHosts_;
  NSUInteger maxRunningFetchersPerHost_;

  DCGTMHTTPFetchHistory *fetchHistory_;
...
// Fetch history
@property (retain) DCGTMHTTPFetchHistory *fetchHistory;
...
@property (nonatomic, retain) id <DCGTMFetcherAuthorizationProtocol> authorizer;
