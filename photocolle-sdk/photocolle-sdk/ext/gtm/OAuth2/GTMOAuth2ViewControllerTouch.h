...
typedef void (^DCGTMOAuth2ViewControllerCompletionHandler)(DCGTMOAuth2ViewControllerTouch *viewController, DCGTMOAuth2Authentication *auth, NSError *error);

@interface DCGTMOAuth2ViewControllerTouch : UIViewController<UINavigationControllerDelegate, UIWebViewDelegate> {
 @private
  ...
  DCGTMOAuth2ViewControllerCompletionHandler completionBlock_;
...
// requests
@property (nonatomic, retain, readonly) DCGTMOAuth2Authentication *authentication;

// the underlying object which performs the sign-in networking sequence
@property (nonatomic, retain, readonly) DCGTMOAuth2SignIn *signIn;
...
// this signature.
//
// - (void)viewController:(DCGTMOAuth2ViewControllerTouch *)viewController
...
// To function, DCGTMOAuth2ViewControllerTouch needs a certain amount of access
