...
NSString *const kDCGTMOAuth2ServiceProviderGoogle = @"Google";

NSString *const kDCGTMOAuth2ErrorDomain  = @"com.google.DCGTMOAuth2";

NSString *const kDCGTMOAuth2ErrorMessageKey = @"error";
NSString *const kDCGTMOAuth2ErrorRequestKey = @"request";
NSString *const kDCGTMOAuth2ErrorJSONKey    = @"json";

// Notifications
NSString *const kDCGTMOAuth2FetchStarted        = @"kDCGTMOAuth2FetchStarted";
NSString *const kDCGTMOAuth2FetchStopped        = @"kDCGTMOAuth2FetchStopped";

NSString *const kDCGTMOAuth2FetcherKey          = @"fetcher";
NSString *const kDCGTMOAuth2FetchTypeKey        = @"FetchType";
NSString *const kDCGTMOAuth2FetchTypeToken      = @"token";
NSString *const kDCGTMOAuth2FetchTypeRefresh    = @"refresh";
NSString *const kDCGTMOAuth2FetchTypeAssertion  = @"assertion";
NSString *const kDCGTMOAuth2FetchTypeUserInfo   = @"userInfo";

NSString *const kDCGTMOAuth2ErrorKey                  = @"error";
NSString *const kDCGTMOAuth2ErrorObjectKey            = @"kDCGTMOAuth2ErrorObjectKey";

NSString *const kDCGTMOAuth2ErrorInvalidRequest       = @"invalid_request";
NSString *const kDCGTMOAuth2ErrorInvalidClient        = @"invalid_client";
NSString *const kDCGTMOAuth2ErrorInvalidGrant         = @"invalid_grant";
NSString *const kDCGTMOAuth2ErrorUnauthorizedClient   = @"unauthorized_client";
NSString *const kDCGTMOAuth2ErrorUnsupportedGrantType = @"unsupported_grant_type";
NSString *const kDCGTMOAuth2ErrorInvalidScope         = @"invalid_scope";

NSString *const kDCGTMOAuth2UserSignedIn              = @"kDCGTMOAuth2UserSignedIn";

NSString *const kDCGTMOAuth2AccessTokenRefreshed     = @"kDCGTMOAuth2AccessTokenRefreshed";
NSString *const kDCGTMOAuth2RefreshTokenChanged      = @"kDCGTMOAuth2RefreshTokenChanged";
NSString *const kDCGTMOAuth2AccessTokenRefreshFailed = @"kDCGTMOAuth2AccessTokenRefreshFailed";

NSString *const kDCGTMOAuth2WebViewStartedLoading = @"kDCGTMOAuth2WebViewStartedLoading";
NSString *const kDCGTMOAuth2WebViewStoppedLoading = @"kDCGTMOAuth2WebViewStoppedLoading";
NSString *const kDCGTMOAuth2WebViewKey            = @"kDCGTMOAuth2WebViewKey";
NSString *const kDCGTMOAuth2WebViewStopKindKey    = @"kDCGTMOAuth2WebViewStopKindKey";
NSString *const kDCGTMOAuth2WebViewFinished       = @"finished";
NSString *const kDCGTMOAuth2WebViewFailed         = @"failed";
NSString *const kDCGTMOAuth2WebViewCancelled      = @"cancelled";

NSString *const kDCGTMOAuth2NetworkLost         = @"kDCGTMOAuthNetworkLost";
NSString *const kDCGTMOAuth2NetworkFound        = @"kDCGTMOAuthNetworkFound";
...
// If DCGTMNSJSONSerialization is available, it is used for formatting JSON
...
+ (DCGTMOAuth2AuthorizationArgs *)argsWithRequest:(NSMutableURLRequest *)req
...
@implementation DCGTMOAuth2AuthorizationArgs
...
+ (DCGTMOAuth2AuthorizationArgs *)argsWithRequest:(NSMutableURLRequest *)req
                              ...
                              completionHandler:(id)completionHandler
                                         thread:(NSThread *)thread {
  DCGTMOAuth2AuthorizationArgs *obj;
  obj = [[[DCGTMOAuth2AuthorizationArgs alloc] init] autorelease];
  obj.request = req;
...
@interface DCGTMOAuth2Authentication ()
...
- (BOOL)authorizeRequestArgs:(DCGTMOAuth2AuthorizationArgs *)args;

- (BOOL)authorizeRequestImmediateArgs:(DCGTMOAuth2AuthorizationArgs *)args;

- (BOOL)shouldRefreshAccessToken;

- (void)updateExpirationDate;

- (void)tokenFetcher:(DCGTMHTTPFetcher *)fetcher
    finishedWithData:(NSData *)data
               error:(NSError *)error;

- (void)auth:(DCGTMOAuth2Authentication *)auth
finishedRefreshWithFetcher:(DCGTMHTTPFetcher *)fetcher
       error:(NSError *)error;

- (void)invokeCallbackArgs:(DCGTMOAuth2AuthorizationArgs *)args;
...
@implementation DCGTMOAuth2Authentication
...
+ (id)authenticationWithServiceProvider:(NSString *)serviceProvider
  ...
  DCGTMOAuth2Authentication *obj = [[[self alloc] init] autorelease];
...
- (void)setKeysForResponseDictionary:(NSDictionary *)dict {
  ...
  if (didRefreshTokenChange) {
    ...
    [nc postNotificationName:kDCGTMOAuth2RefreshTokenChanged
                      object:self
                    userInfo:nil];
  }
  // NSLog(@"keys set ----------------------------\n%@", dict);
...
+ (NSDictionary *)dictionaryWithJSONData:(NSData *)data {
  ...
  if (serializer) {
    ...
    if (jsonParseClass) {
      DCGTMOAuth2ParserClass *parser = [[[jsonParseClass alloc] init] autorelease];
...
#if DEBUG
      NSAssert(0, @"DCGTMOAuth2Authentication: No parser available");
#endif
    }
  }
  return nil;
...
- (void)authorizeRequest:(NSMutableURLRequest *)request
  ...
  DCGTMOAuth2AuthorizationArgs *args;
  args = [DCGTMOAuth2AuthorizationArgs argsWithRequest:request
                                            delegate:nil
                                            selector:NULL
...
- (void)authorizeRequest:(NSMutableURLRequest *)request
  ...
  DCGTMAssertSelectorNilOrImplementedWithArgs(delegate, sel,
                                            @encode(DCGTMOAuth2Authentication *),
...
finishedRefreshWithFetcher:(DCGTMHTTPFetcher *)fetcher
  ...
  @synchronized(authorizationQueue_) {
    ...
    if (hasAccessToken && error == nil) {
      // Successful refresh.
      noteName = kDCGTMOAuth2AccessTokenRefreshed;
      userInfo = nil;
    } else {
      ...
      noteName = kDCGTMOAuth2AccessTokenRefreshFailed;
      NSString *jsonErr = nil;
      if ([error code] == kDCGTMHTTPFetcherStatusBadRequest) {
        NSDictionary *json = [[error userInfo] objectForKey:kDCGTMOAuth2ErrorJSONKey];
        jsonErr = [json objectForKey:kDCGTMOAuth2ErrorMessageKey];
      }
      // error and jsonErr may be nil
      userInfo = [NSMutableDictionary dictionary];
      [userInfo setValue:error forKey:kDCGTMOAuth2ErrorObjectKey];
      [userInfo setValue:jsonErr forKey:kDCGTMOAuth2ErrorMessageKey];
    }
    NSNotificationCenter *nc = [NSNotificationCenter defaultCenter];
    ...
    for (DCGTMOAuth2AuthorizationArgs *args in pendingAuthQueue) {
...
- (BOOL)isAuthorizingRequest:(NSURLRequest *)request {
  BOOL wasFound = NO;
  @synchronized(authorizationQueue_) {
    for (DCGTMOAuth2AuthorizationArgs *args in authorizationQueue_) {
  ...
  if (isAuthorizableRequest && [accessToken length] > 0) {
    if (request) {
      ...
      NSString *value = [NSString stringWithFormat:@"%s %@",
                         DCGTM_OAUTH2_BEARER, accessToken];
    ...
    if (request) {
      userInfo = [NSDictionary dictionaryWithObject:request
                                             forKey:kDCGTMOAuth2ErrorRequestKey];
    }
    NSInteger code = (isAuthorizableRequest ?
                      kDCGTMOAuth2ErrorAuthorizationFailed :
                      kDCGTMOAuth2ErrorUnauthorizableRequest);
    args.error = [NSError errorWithDomain:kDCGTMOAuth2ErrorDomain
                                     code:code
                                 userInfo:userInfo];
  }
...
- (void)waitForCompletionWithTimeout:(NSTimeInterval)timeoutInSeconds {
  ...
  DCGTMHTTPFetcher *fetcher = self.refreshFetcher;
...
- (DCGTMHTTPFetcher *)beginTokenFetchWithDelegate:(id)delegate
  ...
  if (refreshToken) {
    ...
    fetchType = kDCGTMOAuth2FetchTypeRefresh;
  } else if (code) {
    ...
    fetchType = kDCGTMOAuth2FetchTypeToken;
  } else if (assertion) {
    ...
    fetchType = kDCGTMOAuth2FetchTypeAssertion;
  } else {
#if DEBUG
 ...
 forHTTPHeaderField:@"Content-Type"];
  ...
  id <DCGTMHTTPFetcherServiceProtocol> fetcherService = self.fetcherService;
  if (fetcherService) {
  ...
  if ([fetcher beginFetchWithDelegate:self
    ...
    NSError *error = [NSError errorWithDomain:kDCGTMHTTPFetcherStatusDomain
                                         code:-1
                                     userInfo:nil];
  ...
  if (error) {
      ...
      if (isResponseJSON) {
        ...
        if ([errorJson count] > 0) {
          ...
          userInfo = [NSMutableDictionary dictionaryWithObject:errorJson
                                                        forKey:kDCGTMOAuth2ErrorJSONKey];
    ...
    if (hasData) {
      ...
      if (tokenType == nil
        ...
        NSLog(@"DCGTMOAuth2: Unexpected token type: %@", tokenType);
      }
#endif
    }
  }
...
- (void)notifyFetchIsRunning:(BOOL)isStarting
  ...
  NSString *name = (isStarting ? kDCGTMOAuth2FetchStarted : kDCGTMOAuth2FetchStopped);
  NSDictionary *dict = [NSDictionary dictionaryWithObjectsAndKeys:
                        fetcher, kDCGTMOAuth2FetcherKey,
                        fetchType, kDCGTMOAuth2FetchTypeKey, // fetchType may be nil
                        nil];
